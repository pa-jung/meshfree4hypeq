...
"""
function flux(eq::Euler1D, rho::Real, m::Real, E::Real)::NTuple{3, Float64}
...
"""
function pressure_from_euler_conserved(rho::Real, mx::Real, my::Real, E::Real)::Float64
    if rho < 1e-9; return 1e-9; end
...
"""
function flux(eq::Euler2D, rho::Real, mx::Real, my::Real, E::Real)::NTuple{2, NTuple{4, Float64}}
    if rho < 1e-9
